<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Masters/Root.master" AutoEventWireup="true" CodeBehind="Voters.aspx.cs" Inherits="QuorumWeb.Views.Admin.Voters" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="PageContent" runat="server">
    ...
    <dx:ASPxGridView ID="ASPxGridView1" runat="server"
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn FieldName="Name" Caption="Nombres" Width="200" VisibleIndex="1">
            </dx:GridViewDataTextColumn>
    ...
    <asp:SqlDataSource runat="server" ID="DataSourceMaster"
        ...
        DeleteCommand="DELETE FROM [Voters] WHERE [ID] = @ID"
        InsertCommand="INSERT INTO [Voters] ([Name], [Identification]) VALUES (@Name, @Identification)"
        SelectCommand="SELECT [ID], [Name], [Identification] FROM [Voters]"
        UpdateCommand="UPDATE [Voters] SET [Name] = @Name, [Identification] = @Identification WHERE [ID] = @ID">
        <DeleteParameters>
