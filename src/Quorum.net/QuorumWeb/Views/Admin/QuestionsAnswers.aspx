<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Masters/Root.master" AutoEventWireup="true" CodeBehind="QuestionsAnswers.aspx.cs" Inherits="QuorumWeb.Views.Admin.QuestionsAnswers" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="PageContent" runat="server">
    ...
    <dx:ASPxGridView ID="ASPxGridView1" runat="server"
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn FieldName="ID" ReadOnly="True" VisibleIndex="0" Width="60">
                <EditFormSettings Visible="False"></EditFormSettings>
            </dx:GridViewDataTextColumn>

            <dx:GridViewDataComboBoxColumn FieldName="QuestionsID" Caption="Pregunta" Width="200" VisibleIndex="1" GroupIndex="1">
                <PropertiesComboBox DataSourceID="SqlDataSourceQuestions"
                    ValueField="ID" ValueType="System.Int32" TextField="Question">
            ...
            <dx:GridViewDataTextColumn FieldName="Answer" Caption="Respuesta" VisibleIndex="2" Width="200">
                <PropertiesTextEdit>
                    <ValidationSettings>
                        <RequiredField IsRequired="true" />
                    </ValidationSettings>
    ...
    <asp:SqlDataSource runat="server" ID="DataSourceMaster"
        ...
        DeleteCommand="DELETE FROM [QuestionsAnswers] WHERE [ID] = @ID"
        InsertCommand="INSERT INTO [QuestionsAnswers] ([QuestionsID], [Answer]) VALUES (@QuestionsID, @Answer)"
        SelectCommand="SELECT [ID], [QuestionsID], [Answer] FROM [QuestionsAnswers]"
        UpdateCommand="UPDATE [QuestionsAnswers] SET [QuestionsID] = @QuestionsID, [Answer] = @Answer WHERE [ID] = @ID">
        <DeleteParameters>
            <asp:Parameter Name="ID" Type="Int32"></asp:Parameter>
        </DeleteParameters>
        <InsertParameters>
            <asp:Parameter Name="QuestionsID" Type="Int32"></asp:Parameter>
    ...
    <asp:SqlDataSource runat="server" ID="SqlDataSourceQuestions"
        ...
        ConnectionString='<%$ ConnectionStrings:MsSqlServer.Main %>'
        OnInit="DBMainDataSources_Init"
        OnSelecting="DBMainDataSources_Selecting" SelectCommand="SELECT [ID], [Question] FROM [Questions]"></asp:SqlDataSource>
