<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Masters/Root.master" AutoEventWireup="true" CodeBehind="Organizations.aspx.cs" Inherits="QuorumWeb.Views.Admin.Organizations" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="PageContent" runat="server">
    ...
    <h2>Organizaciones u Empresas</h2>
    ...
    <dx:ASPxGridView ID="ASPxGridView1" runat="server"
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn FieldName="Name" Caption="Razon Social" Width="240" VisibleIndex="1">
            </dx:GridViewDataTextColumn>

            <dx:GridViewDataTextColumn FieldName="Identification" Caption="Identificacion" Width="120" VisibleIndex="2"></dx:GridViewDataTextColumn>

            <dx:GridViewDataTextColumn FieldName="Shareholding" Caption="%Participacion" Width="120" PropertiesTextEdit-HelpText="Valor en Porcentaje" VisibleIndex="3">
                <PropertiesTextEdit>
                    <ValidationSettings CausesValidation="True" RequiredField-IsRequired="True" ErrorDisplayMode="ImageWithText" ErrorTextPosition="Bottom">
                        <RegularExpression ValidationExpression="^\d{1,3}(?:\.\d{1,9})?$" ErrorText="Valor no válido." />
                    </ValidationSettings>
                </PropertiesTextEdit>
            </dx:GridViewDataTextColumn>
    ...
    <asp:SqlDataSource runat="server" ID="DataSourceMaster"
        ...
        InsertCommand="INSERT INTO [Organizations] ([Name], [Identification], [Shareholding]) VALUES (@Name, @Identification, @Shareholding)"
        SelectCommand="SELECT [ID], [Name], [Identification], [Shareholding] FROM [Organizations]"
        UpdateCommand="UPDATE [Organizations] SET [Name] = @Name, [Identification] = @Identification, [Shareholding] = @Shareholding WHERE [ID] = @ID">
        <DeleteParameters>
            <asp:Parameter Name="ID" Type="Int32"></asp:Parameter>
        </DeleteParameters>
        <InsertParameters>
            <asp:Parameter Name="Name" Type="String"></asp:Parameter>
            <asp:Parameter Name="Identification" Type="String"></asp:Parameter>
            <asp:Parameter Name="Shareholding" Type="Decimal"></asp:Parameter>
        </InsertParameters>
        <UpdateParameters>
            <asp:Parameter Name="Name" Type="String"></asp:Parameter>
            <asp:Parameter Name="Identification" Type="String"></asp:Parameter>
