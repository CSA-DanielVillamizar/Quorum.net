<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Masters/Root.master" AutoEventWireup="true" CodeBehind="Questions.aspx.cs" Inherits="QuorumWeb.Views.Admin.Questions" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="PageContent" runat="server">
    ...
    <dx:ASPxGridView ID="ASPxGridView1" runat="server"
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn FieldName="Question" Caption="Pregunta" VisibleIndex="1" Width="200" ></dx:GridViewDataTextColumn>
    ...
    <asp:SqlDataSource runat="server" ID="DataSourceMaster"
        ...
        InsertCommand="INSERT INTO [Questions] ([Question]) VALUES (@Question)"
        SelectCommand="SELECT [ID], [Question] FROM [Questions]"
        UpdateCommand="UPDATE [Questions] SET [Question] = @Question WHERE [ID] = @ID">
        <DeleteParameters>
