...
{
    public partial class Roles : BINumber_Web.UI.PageBaseGrid
    {
        private const string cachePageName = "Roles";

        protected void Page_PreInit(object sender, EventArgs e)
        {
            base.Page_PreInit(sender, e);
            PageTitle = "Administración Roles de Usuario";
        ...
        {
            if (!Permissions.GetPermission(UserPermissionTypeEnum.BINUMBER_ACCESO_ROLES, Session, Global.DAL.GetConnectionStringDBData()))
            {
                Response.Redirect("~/ErrorPermission.html", true);
            }
            SecurityCanInsert = Permissions.GetPermission(UserPermissionTypeEnum.BINUMBER_ACCESO_ROLES, Session, Global.DAL.GetConnectionStringDBData());
            SecurityCanUpdate = Permissions.GetPermission(UserPermissionTypeEnum.BINUMBER_ACCESO_ROLES, Session, Global.DAL.GetConnectionStringDBData());
            SecurityCanDelete = Permissions.GetPermission(UserPermissionTypeEnum.BINUMBER_ACCESO_ROLES, Session, Global.DAL.GetConnectionStringDBData());
...
";
        ...
        protected void grid_ParseValue(object sender, DevExpress.Web.Data.ASPxParseValueEventArgs e)
        {
            if (ASPxGridView1.IsNewRowEditing)
            {
                if (e.FieldName == "UserRolId") e.Value = 0;
        ...
        protected void ASPxGridView1Detail_RowInserting(object sender, DevExpress.Web.Data.ASPxDataInsertingEventArgs e)
        {
            ...
            e.NewValues["UserRolId"] = lgrid.GetMasterRowKeyValue().ToString();
        ...
        protected void ASPxGridView1Detail_ParseValue(object sender, DevExpress.Web.Data.ASPxParseValueEventArgs e)
        {
            ...
            {
                if (e.FieldName == "UserRolPerId") e.Value = 0;
